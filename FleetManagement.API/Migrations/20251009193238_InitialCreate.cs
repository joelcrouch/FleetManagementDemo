        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PartsReplaced = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ResolutionNotes = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ServiceAlerts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ServiceAlerts_Vehicles_VehicleId",
                        column: x => x.VehicleId,
                        principalTable: "Vehicles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceAlerts_IsResolved",
                table: "ServiceAlerts",
                column: "IsResolved");

            migrationBuilder.CreateIndex(
                name: "IX_ServiceAlerts_Priority",
                table: "ServiceAlerts",
                column: "Priority");

            migrationBuilder.CreateIndex(
                name: "IX_ServiceAlerts_VehicleId",
                table: "ServiceAlerts",
                column: "VehicleId");
